 ...
 * @author sinhs
 */
@WebServlet(name = "carts_successful_shipping", urlPatterns = {"/carts_successful_shipping"})
public class carts_successful_shipping extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        int status = carts.updateStatus(id,3);
