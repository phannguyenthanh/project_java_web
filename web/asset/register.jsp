...
<head>
	...
	<meta charset="utf-8" />
       ...
       <![endif]-->
       <title>
      ÄÄng kÃ½ tÃ i khoáº£n  Super store
       </title>
       ...
       <link href='css/responsive.css' rel='stylesheet' type='text/css' />
		...
		<meta property="og:title" content="ÄÄng kÃ½ tÃ i khoáº£n" />
                      ...
                      <div class="reg-shop">
                        ...
                        <div class="userbox">
                          <form accept-charset='UTF-8' action='/account/register' id='customer_register' method='post'>
                            ...
                            <p class="text-reg">Báº¡n ÄÃ£ cÃ³ tÃ i khoáº£n? HÃ£y <a href="/account/login">ÄÄng nháº­p</a></p>
                            <ul class="form-list row">
                              <li class="col-sm-6 col-xs-12">
                                <div class="customer-name">
                                  <div class="input-box name-firstname">
                                    <label for="firstname"> TÃªn <span class="required">*</span></label>
                                    <br>
                                    <input type="text" name="FirstName" title="TÃªn" class="input-text "placeholder="TÃªn" id="firstname">
                                  </div>
                                </div>
                              </li>
                              <li class="col-sm-6 col-xs-12">
                                <div class="input-box name-lastname">
                                  <label for="lastname"> Há» <span class="required">*</span> </label>
                                  <br>
                                  <input type="text" class="input-text" value="" id="lastname" title="email" name="LastName" id="email" placeholder="Há»" >
                                </div>
                              </li>
                              <li class="col-sm-6 col-xs-12">
                              ...
                              <li class="col-sm-6 col-xs-12">
                                <label for="pass">Máº­t kháº©u<span class="required">*</span></label>
                                <br>                
                                <input type="password" value="" class="input-text" title="Máº­t kháº©u" name="password" id="pass" placeholder="Máº­t kháº©u">
                              </li>
                            </ul>
                            <p class="required"><span class="required">*</span> Báº¯t buá»c</p>
                            <div class="buttons-set">
                              <button id="send2" type="submit" class="button login"><span>ÄÄng kÃ½</span></button>              
                              <!--hoáº·c <a href="/account/login">ÄÄng nháº­p</a> -->
                            </div>
                          </form>
                        </div>
                      </div>
