...
//                                                        String tenlop = dslop.get(i).getTenlop();
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="index.jsp?status=EditType&id=<%=list.get(i).getId()%>" class="btn btn-brand active">Sửa </a>
                                                    <a href="../type_delete?id=<%=list.get(i).getId()%>" class="btn btn-danger active">Xóa </a>
                                                    <a href="index.jsp?status=DetailType&id=<%=list.get(i).getId()%>" class="btn btn-info active">Chi Tiết </a>
                                                </td>
                                            </tr>
                                            <%
                                                }
