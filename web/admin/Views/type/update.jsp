            ...
            <div class="card-body">
                ...
                <form method="post" action="../products_edit"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-12 col-sm-8 col-lg-6">
                            <input type="text" required="" name="made_in" value="<%=u.getMade_in()%>" placeholder="Nơi sản xuất" class="form-control">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-12 col-sm-3 col-form-label text-sm-right"> Phân khối </label>
                        <div class="col-12 col-sm-8 col-lg-6">
                            <input type="text" required="" name="capacity" value="<%=u.getCapacity()%>" placeholder="Phân khối " class="form-control">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-12 col-sm-3 col-form-label text-sm-right">Màu </label>
                        <div class="col-12 col-sm-8 col-lg-6">
                            <input type="text" required="" name="color" value="<%=u.getColor()%>" placeholder="Màu " class="form-control">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-12 col-sm-3 col-form-label text-sm-right"> Model Year </label>
                        <div class="col-12 col-sm-8 col-lg-6">
                            <input type="text" required="" name="model_year" value="<%=u.getModel_year()%>" placeholder="Model của năm " class="form-control">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-12 col-sm-8 col-lg-6">
                            <input type="text" required="" name="location" value="<%=u.getLocation()%>" placeholder="Đại chỉ " class="form-control">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-12 col-sm-8 col-lg-6">
                            <input type="text" required="" name="content" value="<%=u.getContent()%>"  placeholder="Nội dung " class="form-control">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-12 col-sm-8 col-lg-6">
                            <select class="form-control form-control-sm" name="brand">
                                ...
                                %>
                                <option value="<%=listbrands.get(i).getId()%>" 
                                        <%
                                        ...
                                        ><%=listbrands.get(i).getName()%></option>
                                <%
                                    }
                                %>
                            </select>
